...
export default function AllProjects () {
  ...
  return (
    <div>
      <Navbar />
      <div className={`${!visible2 ? 'section0':'section3'}  ${visible4 && 'section1'} ${visible5 && 'section2'}`}></div>
      ...
      <div ref={ref2} className={`h-[150vh] text-white flex flex-col justify-center `}>
        <h1 className={`pl-[10.42%] ${visible2 ? 'white':'black'}`}>ux</h1>
      ...
      <div ref={ref4} className='h-[150vh] text-white flex flex-col justify-center'>
        <h1 className={`pl-[10.42%] ${visible4 ? 'white':'black'}`}>ui</h1>
        <h1 className='text-center'>Design</h1>
      </div>
      <div ref={ref5} className="flex flex-col py-[150px]  items-center justify-center ">
        <ContextProjects 
          picture={image5}
          picture1={image5}
          head= 'ntfloan'
