  ...
  return (
    <>
      ...
      <div className='h-full w-full flex items-end justify-end'>
        <div data-aos="fade-left" className=' float-right mr-[150px] mb-[40px]'> 
          <div className=' w-[117px] h-[118px] flex justify-center  items-center rounded-full border-solid border-2 border-white '>
            <p> Download Resume </p>
          </div>
        </div>
      </div>
